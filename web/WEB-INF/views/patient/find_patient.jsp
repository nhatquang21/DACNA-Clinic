            ...
            <div class="card my-4">
                ...
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white  ps-3">Hồ sơ bệnh nhân cũ</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="patient__Content d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div class="addpatient__Form container">
                            ...
                            <div class="content">
                                <form action="${pageContext.request.contextPath}/patient/find_patient_handle.do" >
                                    <div class="user-details">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <input value="${bn.email}"   name="txtEmail" type="text" placeholder="Nhập email" style="
                                    ...
                                    <div class="button">
                                        <input type="submit" value="Khám bệnh" name="op">
                                    </div>
                                    <div style="
                                         font-style: italic;
                                         color: red;
